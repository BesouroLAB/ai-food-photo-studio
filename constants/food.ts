...
const FOOD_PRESETS: StudioPreset[] = [
    { name: 'Sobremesas & Doces', description: 'Cores suaves e foco em detalhes delicados.', icon: DessertIcon, preset: { cameraName: 'Hasselblad X2D 100C + 90mm f/2.5', depthOfFieldName: 'DoF Raso (Fundo Desfocado)', lightingName: 'Luz Lateral Difusa (Janela)', angle: 'Close-up/Macro (Detalhe)', stylePlaceholder: 'Torta de frutas vermelhas em um prato de cerâmica, com foco na textura do creme, luz suave da janela criando um brilho etéreo.' }, examples: ["cake", "pie", "tart", "cupcake", "donuts", "dessert", "sweet textures"] },
    { name: 'Carnes & Churrasco', description: 'Realça a suculência e as marcas de grelhado.', icon: MeatIcon, preset: { cameraName: 'Nikon Z8 + 85mm f/1.8', depthOfFieldName: 'DoF Raso (Fundo Desfocado)', lightingName: 'Luz Lateral Dura (Textura Intensa)', angle: 'Ângulo Baixo (Visão Imponente)', stylePlaceholder: 'Picanha grelhada suculenta em uma tábua de madeira rústica, com marcas de grelhado bem definidas, fumaça leve subindo.' }, examples: ["steak", "ribeye", "picanha", "barbecue", "juicy meat", "grill marks"] },
    { name: 'Saladas & Pratos Leves', description: 'Luz limpa para destacar o frescor e as cores.', icon: SaladIcon, preset: { cameraName: 'Canon EOS R5 + 50mm f/2.8', depthOfFieldName: 'DoF Profundo (Tudo em Foco)', lightingName: 'Luz de Estúdio Branca (Catálogo)', angle: 'Flat Lay 90° (Vista de Cima)', stylePlaceholder: 'Salada de verão vibrante em uma tigela branca, sobre um fundo de mármore claro, com todos os ingredientes nítidos.' }, examples: ["salad bowl", "fresh vegetables", "colorful ingredients", "healthy food", "top view"] },
    { name: 'Bebidas & Drinks', description: 'Realça o brilho e a refrescância dos líquidos.', icon: DrinkIcon, preset: { cameraName: 'Panasonic Lumix S5 II + 85mm f/1.8', depthOfFieldName: 'DoF Raso (Fundo Desfocado)', lightingName: 'Backlight (Contraluz para Brilho)', angle: 'Nível do Olhar 0° (Visão Frontal)', stylePlaceholder: 'Caipirinha em um copo de cristal, com gelo e uma rodela de limão, em um balcão de bar escuro no Rio de Janeiro, luz de fundo fazendo o líquido brilhar.' }, examples: ["cocktail", "juice", "smoothie", "condensation", "transparent glass", "backlit drink"] },
    { name: 'Hambúrgueres & Lanches', description: 'Captura todas as camadas de forma heroica.', icon: BurgerIcon, preset: { cameraName: 'Canon EOS R3 + 50mm f/1.4', depthOfFieldName: 'DoF Raso (Fundo Desfocado)', lightingName: 'Golden Hour (Luz Quente Suave)', angle: 'Nível do Olhar 0° (Visão Frontal)', stylePlaceholder: 'Hambúrguer artesanal com queijo derretendo, em uma hamburgueria artesanal em Pinheiros (São Paulo), com a luz dourada do pôr do sol.' }, examples: ["burger", "cheeseburger", "sandwich", "melted cheese", "dripping sauce", "hero shot"] },
    { name: 'Massas & Pratos Asiáticos', description: 'Cria uma atmosfera quente e reconfortante.', icon: PastaIcon, preset: { cameraName: 'Canon EOS R6 II + 85mm f/2.0', depthOfFieldName: 'DoF Raso (Fundo Desfocado)', lightingName: 'Luz Lateral Difusa (Janela)', angle: 'Ângulo 45° (Visão da Mesa)', stylePlaceholder: 'Prato de carbonara cremoso em uma tigela de cerâmica rústica, ao lado de uma janela com luz suave, vapor subindo delicadamente.' }, examples: ["pasta", "ramen", "noodles", "risotto", "steaming bowl", "creamy sauce"] },
    { name: 'Pizza', description: 'Look rústico que destaca a crocância e o calor.', icon: PizzaIcon, preset: { cameraName: 'Sony A7 IV + 35mm f/2.8', depthOfFieldName: 'DoF Médio (Foco Equilibrado)', lightingName: 'Luz Contínua Quente (Ambiente de Restaurante)', angle: 'Flat Lay 90° (Vista de Cima)', stylePlaceholder: 'Pizza recém-saída do forno em uma tábua de madeira, com queijo derretido e manjericão fresco, em uma cantina italiana no Bixiga (São Paulo), com toalha xadrez.' }, examples: ["pizza slice", "margherita", "cheese pull", "rustic oven", "top view"] },
    { name: 'Comida Japonesa', description: 'Estilo elegante e minimalista para pratos delicados.', icon: SushiIcon, preset: { cameraName: 'Ricoh GR IIIx + 40mm f/2.8', depthOfFieldName: 'DoF Raso (Fundo Desfocado)', lightingName: 'Low-Key (Luz Dramática e Contraste)', angle: 'Ângulo 45° (Visão da Mesa)', stylePlaceholder: 'Prato de sushi minimalista em uma placa de ardósia escura, com iluminação dramática destacando o brilho do peixe.' }, examples: ["sushi", "sashimi", "nigiri", "minimalist", "japanese food styling", "chopsticks"] },
    { name: 'Comida Brasileira', description: 'Luz natural para um look autêntico e convidativo.', icon: BrazilianFoodIcon, preset: { cameraName: 'Canon EOS R6 II + 50mm f/1.8', depthOfFieldName: 'DoF Médio (Foco Equilibrado)', lightingName: 'Luz Lateral Difusa (Janela)', angle: 'Ângulo 45° (Visão da Mesa)', stylePlaceholder: 'Feijoada servida em uma panela de barro sobre uma mesa de madeira, com luz natural de uma janela, criando uma atmosfera familiar.' }, examples: ["feijoada", "moqueca", "prato feito", "rustic serving", "brazilian food"] },
    { name: 'Padaria & Pães', description: 'Realça a textura da crosta e o miolo macio.', icon: BakeryIcon, preset: { cameraName: 'Sony A1 + 105mm f/2.8', depthOfFieldName: 'DoF Raso (Fundo Desfocado)', lightingName: 'Golden Hour (Luz Quente Suave)', angle: 'Close-up/Macro (Detalhe)', stylePlaceholder: 'Close-up de um pão de fermentação natural com crosta crocante, polvilhado com farinha, com a luz quente do fim de tarde realçando a textura.' }, examples: ["artisan bread", "croissant", "bakery", "crust detail", "flour dust"] },
    { name: 'Açaí & Bowls', description: 'Cores vibrantes e foco nos toppings frescos.', icon: BowlIcon, preset: { cameraName: 'Sigma fp L + 35mm f/2.0', depthOfFieldName: 'DoF Profundo (Tudo em Foco)', lightingName: 'Luz Lateral Difusa (Janela)', angle: 'Flat Lay 90° (Vista de Cima)', stylePlaceholder: 'Bowl de açaí colorido com frutas frescas brasileiras e granola, fotografado de cima com luz brilhante e uniforme.' }, examples: ["açaí bowl", "smoothie bowl", "fresh fruit", "top view", "vibrant colors"] },
    { name: 'Cafeteria', description: 'Cria uma atmosfera "moody" e aconchegante.', icon: CoffeeIcon, preset: { cameraName: 'Fujifilm X-H2S + 35mm f/1.4', depthOfFieldName: 'DoF Raso (Fundo Desfocado)', lightingName: 'Luz Lateral Difusa (Janela)', angle: 'Ângulo 45° (Visão da Mesa)', stylePlaceholder: 'Xícara de cappuccino com latte art em uma mesa de madeira de uma cafeteria charmosa no Rio de Janeiro, com luz suave vinda da janela.' }, examples: ["coffee", "latte art", "cappuccino", "cozy coffee shop", "steam rising"] },
    { name: 'Frutos do Mar', description: 'Estilo limpo e fresco para destacar a qualidade.', icon: BowlIcon, preset: { cameraName: 'Sony A7 IV + 100mm f/2.8', depthOfFieldName: 'DoF Raso (Fundo Desfocado)', lightingName: 'Luz Lateral Difusa (Janela)', angle: 'Ângulo 45° (Visão da Mesa)', stylePlaceholder: 'Prato de camarões grelhados com limão e ervas, com luz natural destacando o brilho e a textura, em um restaurante na beira da praia.' }, examples: ["seafood", "shrimp", "lobster", "grilled fish", "fresh catch"] },
    { name: 'Café da Manhã', description: 'Cena matinal, leve e arejada.', icon: CoffeeIcon, preset: { cameraName: 'Google Pixel 8 Pro', depthOfFieldName: 'DoF Raso (Fundo Desfocado)', lightingName: 'Luz Lateral Difusa (Janela)', angle: 'Flat Lay 90° (Vista de Cima)', stylePlaceholder: 'Mesa de café da manhã de hotel brasileiro com pão de queijo, mamão e suco de laranja, com luz matinal brilhante e suave.' }, examples: ["pancakes", "waffles", "breakfast spread", "morning light", "flat lay"] },
    { name: 'Sopas & Caldos', description: 'Destaca o vapor e a textura dos ingredientes.', icon: BowlIcon, preset: { cameraName: 'Panasonic Lumix S5 II + 50mm f/1.8', depthOfFieldName: 'DoF Médio (Foco Equilibrado)', lightingName: 'Backlight (Contraluz para Brilho)', angle: 'Flat Lay 90° (Vista de Cima)', stylePlaceholder: 'Tigela de caldo verde quente, com vapor subindo, iluminada por trás para realçar a textura cremosa.' }, examples: ["soup bowl", "stew", "broth", "steam rising", "comfort food"] },
    { name: 'Comida Mexicana', description: 'Cores vibrantes e texturas em close-up.', icon: BurgerIcon, preset: { cameraName: 'iPhone 15 Pro', depthOfFieldName: 'DoF Raso (Fundo Desfocado)', lightingName: 'Luz Lateral Dura (Textura Intensa)', angle: 'Close-up/Macro (Detalhe)', stylePlaceholder: 'Close-up de um taco com ingredientes frescos e coloridos, com luz direta criando um look vibrante e de alto contraste.' }, examples: ["tacos", "burrito", "guacamole", "vibrant colors", "mexican food"] }
];
